...
Backend unit tests cover time estimation logic, including:
- Positive and negative fractional working days
- Skipping holidays
- Calculation of end date/time based on start date/time and working hours
---------------------------------------------------------------------------------
